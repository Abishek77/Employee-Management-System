    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin.php">
                ...
                <div class="sidebar-brand-text mx-3">NDU<sup>ADMIN</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php">All clients</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4 text-danger">The changes made here will reflect the clients database <a target="_blank"
                            href="/ndu/admin.php">Back to home</a>.</p>
                                ...
                                <table class="table table-bordered text-light" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                     <?php while ($client = mysqli_fetch_assoc($result1)){  ;?>
                                        <tr>
                                        <form action ="aggrements.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <td><input type="file"  name="file3" class="" value="<?php echo $client['content3'] ?>" >existing file:<?php echo $client['file3'] ?> </td>  
                                            
                                               
                                                                              
                                            <td> <button name="submit" type="submit" class="btn-secondary btn"> Add </button> </td>
